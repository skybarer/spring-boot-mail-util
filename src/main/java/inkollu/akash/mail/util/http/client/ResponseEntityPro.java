...
import inkollu.akash.mail.util.json.JsonUtils;
import lombok.Data;
...
public class ResponseEntityPro {
    ...
    public static <T> ResponseEntity<T> status(final int status, final T body, final String filterFields) {
        ...
        return status(status, (T) JsonUtils.jsonToType(
                JsonUtils.toFilterJson(body, filterFields),
                body.getClass()));
    }
    ...
    public ResponseEntityPro flushBodyByFilterFields(final String filterFields) {
        ...
        this.body = JsonUtils.jsonToType(
                JsonUtils.toFilterJson(this.body, filterFields),
                MAP_TYPE_REFERENCE);
        return this;
    }
